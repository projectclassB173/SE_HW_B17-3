...
import sqlite3 
conn = sqlite3.connect('C:\\项目实战\\作业\\zjd.db') 
...
conn.execute("INSERT INTO addressbook (ID,NAME,TELEPHONE,COMPANY,ADDRESS) \
    VALUES (1, 'MINT', 18537469741, 'a公司','浦东')")
conn.execute("INSERT INTO addressbook (ID,NAME,TELEPHONE,COMPANY,ADDRESS) \
    VALUES (2, 'fancy', 14785236909, 'b公司','青浦')") 
conn.commit() 
...
conn.execute("delete from addressbook where NAME='fancy'") 
conn.commit() 
