...
import sqlite3
conn = sqlite3.connect('D:\\课程\\大三下\\test.db')
print("success");
...
conn.execute("INSERT INTO USER (ID,NAME,TELEPHONE,COMPANY,ADDRESS) \
    VALUES (1, '1', 12121212121, '1公司','上海')")
conn.execute("INSERT INTO USER (ID,NAME,TELEPHONE,COMPANY,ADDRESS) \
    VALUES (2, '2', 12345678901, '2公司','北京')")
conn.execute("INSERT INTO USER (ID,NAME,TELEPHONE,COMPANY,ADDRESS) \
    VALUES (3, '3', 11111111111, '3公司','广州')")
conn.commit()
...
conn = sqlite3.connect('D:\\课程\\大三下\\test.db')
print("Opened database successfully")
conn.execute("delete from USER where COMPANY='2公司'")
conn.commit()
...
conn = sqlite3.connect('D:\\课程\\大三下\\test.db')
print("Opened database successfully")
conn.execute("UPDATE USER set Company = '1公司' where ID=1")
conn.commit()
print("Total number of rows updated :", conn.total_changes)
